...
function RenderNode({
  ...
  const Renderer = map[node.type] ?? FallbackNode;
 ...
 * between a considered empty state and a blank rectangle.
 */
 ...
 * renders structured HTML rather than throwing: one unmapped component must
 * never take down a surface that is otherwise fine.
 */
